 ...
 // Methods 
   ...
   public void Save (String fileName){
      try{
         ...
         fileOut.writeInt(numOfItems);
         fileOut.writeObject(customer.getName());
      
         for(int i= 0 ; i<numOfItems;i++)
            fileOut.writeObject(itemList[i]);
      
         fileOut.close();
         JOptionPane.showMessageDialog(null,"Save all informtion is done");
      // check exception
